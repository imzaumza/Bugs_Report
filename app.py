...
SPREADSHEET_ID = "1guE93RVGKfCn-9mVVEgVbrv4L3VCbpaHEu548pD6osc"
SHEET_NAME = "Database"
...
st.sidebar.write(
    f"This app shows how a Developers app can interact easily with a [Google Sheet]({GSHEET_URL}) to read or store data."
)
...
if submitted:
    ...
    st.success("Thanks! Your bug was successfuly recorded.")
    st.balloons()
